 ...
 */
inline NSString *NSStringFromGLViewDeckSide(__enum_GLVIEW_SIDE side)
{
    switch (side) {
        case GLVIEWSIDE_LEFT:
            return @"left";
        case GLVIEWSIDE_RIGHT:
            return @"right";
        case GLVIEWSIDE_TOP:
            return @"top";
        case GLVIEWSIDE_BOTTOM:
            return @"bottom";
        default:
            return @"unkown";
    }
 ...
 */
inline __enum_GLVIEW_ORIENTATION glViewDeckOffsetOrientationFromGLViewDeckSize(__enum_GLVIEW_SIDE side)
{
    switch (side) {
        case GLVIEWSIDE_LEFT:
        case GLVIEWSIDE_RIGHT:
            return GLVIEW_ORIENTATION_HORIZONTAL;
        case GLVIEWSIDE_TOP:
        case GLVIEWSIDE_BOTTOM:
            return GLVIEW_ORIENTATION_VERTICAL;
        default:
            return GLVIEW_ORIENTATION_NO;
    }
}

static const UIViewAnimationOptions defaultSwipedAnimationCurve = UIViewAnimationOptionCurveEaseInOut;
...
static NSTimeInterval durationToAnimate (CGFloat pointsToAnimate, CGFloat velocity)
{
    ...
    if (defaultSwipedAnimationCurve != UIViewAnimationOptionCurveLinear) {
...
@interface IIViewDeckView : UIView {
    BOOL m_userInteractionEnabled_;
}

@property (nonatomic, assign) BOOL m_allowUserInteractionEnabled_;
...
@interface GLDeckViewController () <UIGestureRecognizerDelegate>

@property (nonatomic, strong) UIView* referenceView_;
@property (nonatomic, readonly) CGRect referenceBounds_;
@property (nonatomic, readonly) CGRect centerViewBounds_;
@property (nonatomic, readonly) CGRect sideViewBounds_;
@property (nonatomic, strong) NSMutableArray* panners_;
@property (nonatomic, assign) CGFloat originalShadowRadius_;
@property (nonatomic, assign) CGFloat originalShadowOpacity_;
@property (nonatomic, strong) UIColor* originalShadowColor_;
@property (nonatomic, assign) CGSize originalShadowOffset_;
@property (nonatomic, strong) UIBezierPath* originalShadowPath_;
@property (nonatomic, strong) UIButton* centerTapper_;
@property (nonatomic, strong) UIView* centerView_;
@property (nonatomic, readonly, strong) UIView* slidingControllerView_;

- (void)cleanUp;

- (CGRect)slidingRectForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
- (CGSize)slidingSizeForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
- (void)setSlidingFrameForOffset:(CGFloat)frame forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
- (void)setSlidingFrameForOffset:(CGFloat)offset limit:(BOOL)limit forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
- (void)setSlidingFrameForOffset:(CGFloat)offset limit:(BOOL)limit panning:(BOOL)panning forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
- (void)panToSlidingFrameForOffset:(CGFloat)frame forOrientation:(__enum_GLVIEW_ORIENTATION)orientation;
...
- (NSArray *)bouncingValuesForViewSide:(__enum_GLVIEW_SIDE)viewSide maximumBounce:(CGFloat)maxBounce numberOfBounces:(CGFloat)numberOfBounces dampingFactor:(CGFloat)zeta duration:(NSTimeInterval)duration;
...
- (BOOL)checkCanOpenSide:(__enum_GLVIEW_SIDE)viewDeckSide;
- (BOOL)checkCanCloseSide:(__enum_GLVIEW_SIDE)viewDeckSide;
- (void)notifyWillOpenSide:(__enum_GLVIEW_SIDE)viewDeckSide animated:(BOOL)animated;
- (void)notifyDidOpenSide:(__enum_GLVIEW_SIDE)viewDeckSide animated:(BOOL)animated;
- (void)notifyWillCloseSide:(__enum_GLVIEW_SIDE)viewDeckSide animated:(BOOL)animated;
- (void)notifyDidCloseSide:(__enum_GLVIEW_SIDE)viewDeckSide animated:(BOOL)animated;
- (void)notifyDidChangeOffset:(CGFloat)offset orientation:(__enum_GLVIEW_ORIENTATION)orientation panning:(BOOL)panning;

- (BOOL)checkDelegate:(SEL)selector side:(__enum_GLVIEW_SIDE)viewDeckSize;
- (void)performDelegate:(SEL)selector side:(__enum_GLVIEW_SIDE)viewDeckSize animated:(BOOL)animated;
- (void)performDelegate:(SEL)selector side:(__enum_GLVIEW_SIDE)viewDeckSize controller:(UIViewController*)controller;
- (void)performDelegate:(SEL)selector offset:(CGFloat)offset orientation:(__enum_GLVIEW_ORIENTATION)orientation panning:(BOOL)panning;
...
- (void)setViewDeckController:(GLDeckViewController*)viewDeckController;
...
@implementation GLDeckViewController

@synthesize panningMode_ = _panningMode;
@synthesize panningCancelTouchesInView_ = _panningCancelsTouchesInView;
@synthesize panners_ = _panners;
@synthesize referenceView_ = _referenceView;
@synthesize slidingViewController_ = _slidingController;
@synthesize centerViewController_ = _centerController;
@dynamic leftViewController_;
@dynamic rightViewController_;
@dynamic topViewController_;
@dynamic bottomViewController_;
@synthesize resizesCenterView_ = _resizesCenterView;
@synthesize originalShadowOpacity_ = _originalShadowOpacity;
@synthesize originalShadowPath_ = _originalShadowPath;
@synthesize originalShadowRadius_ = _originalShadowRadius;
@synthesize originalShadowColor_ = _originalShadowColor;
@synthesize originalShadowOffset_ = _originalShadowOffset;
@synthesize delegate_ = _delegate;
@synthesize delegateMode_ = _delegateMode;
@synthesize navigationControllerBehavior_ = _navigationControllerBehavior;
@synthesize panningView_ = _panningView;
@synthesize centerHiddenInteractivity_ = _centerhiddenInteractivity;
@synthesize centerTapper_ = _centerTapper;
@synthesize centerView_ = _centerView;
@synthesize sizeMode_ = _sizeMode;
@synthesize enabled_ = _enabled;
@synthesize elastic_ = _elastic;
@synthesize autoUpdateTabbarItems_ = _automaticallyUpdateTabBarItems;
@synthesize panningGestureDelegate_ = _panningGestureDelegate;
@synthesize bounceDurationFactor_ = _bounceDurationFactor;
@synthesize bounceOpenSideDurationFactor_ = _bounceOpenSideDurationFactor;
@synthesize openSlideAnimationDuration_ = _openSlideAnimationDuration;
@synthesize closeSlideAnimationDuration_ = _closeSlideAnimationDuration;
@synthesize parallaxAmount_ = _parallaxAmount;
@synthesize centerTapperAccessibilityLabel_ = _centerTapperAccessibilityLabel;
@synthesize centerTapperAccessibilityHint_ = _centerTapperAccessibilityHint;
...
- (void)commonInitWithCenterViewController:(UIViewController *)centerController
{
    ...
    _panningMode = GLVIEW_PANNING_FULLSCREEN;
    _panningCancelsTouchesInView = YES; // let's default to standard IOS behavior.
    _navigationControllerBehavior = GLVIEW_NAVIGATION_CONTROLLER_CONTAINED//IIViewDeckNavigationControllerContained;
    _centerhiddenInteractivity = GLVIEW_HIDDEN_USER_INTERACTIVE;//IIViewDeckCenterHiddenUserInteractive;
    _sizeMode = GLVIEW_SIZE_LEDGE;//IIViewDeckLedgeSizeMode;
    _viewAppeared = 0;
    m_viewFirstAppeared_ = NO;
    ...
    _offsetOrientation = GLVIEW_ORIENTATION_HORIZONTAL;//IIViewDeckHorizontalOrientation
    
    _delegate = nil;
    _delegateMode = GLVIEW_DELEGATE_ONLY;//IIViewDeckDelegateOnly;
...
- (void)didReceiveMemoryWarning
{
    ...
    [self.centerViewController_ didReceiveMemoryWarning];
    [self.leftViewController_ didReceiveMemoryWarning];
    [self.rightViewController_ didReceiveMemoryWarning];
    [self.topViewController_ didReceiveMemoryWarning];
    [self.bottomViewController_ didReceiveMemoryWarning];
...
- (NSArray*)controllers {
    ...
    if (self.centerViewController_) [result addObject:self.centerViewController_];
    if (self.leftViewController_) [result addObject:self.leftViewController_];
    if (self.rightViewController_) [result addObject:self.rightViewController_];
    if (self.topViewController_) [result addObject:self.topViewController_];
    if (self.bottomViewController_) [result addObject:self.bottomViewController_];
    return [NSArray arrayWithArray:result];
}

- (CGRect)referenceBounds {
    return self.referenceView_
    ? self.referenceView_.bounds
    : [[UIScreen mainScreen] bounds];
}

- (CGFloat)relativeStatusBarHeight {
    if (![self.referenceView_ isKindOfClass:[UIWindow class]])
        return 0;
...
- (CGRect)centerViewBounds {
    if (self.navigationControllerBehavior_ == GLVIEW_NAVIGATION_CONTROLLER_CONTAINED)
        return self.referenceBounds_;
    
    return GL_CGRectShrink(self.referenceBounds_, 0, [self relativeStatusBarHeight] + (self.navigationController.navigationBarHidden ? 0 : self.navigationController.navigationBar.frame.size.height));
}
...
- (CGRect)sideViewBounds {
    ...
    return GL_CGRectOffsetTopAndShrink(self.referenceBounds_, [self relativeStatusBarHeight]);
}

- (CGFloat)limitOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
    if (orientation == GLVIEW_ORIENTATION_HORIZONTAL) {
        if (self.leftViewController_ && self.rightViewController_) return offset;
        
        if (self.leftViewController_ && _maxLedge > 0) {
            CGFloat left = self.referenceBounds_.size.width - _maxLedge;
            offset = MIN(offset, left);
        }
        else if (self.rightViewController_ && _maxLedge > 0) {
            CGFloat right = _maxLedge - self.referenceBounds_.size.width;
        ...
        if (self.topViewController_ && self.bottomViewController_) return offset;
        
        if (self.topViewController_ && _maxLedge > 0) {
            CGFloat top = self.referenceBounds_.size.height - _maxLedge;
            offset = MIN(offset, top);
        }
        else if (self.bottomViewController_ && _maxLedge > 0) {
            CGFloat bottom = _maxLedge - self.referenceBounds_.size.height;
...
- (CGRect)slidingRectForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
    ...
    if (orientation == GLVIEW_ORIENTATION_HORIZONTAL) {
        return (CGRect) { {self.resizesCenterView_ && offset < 0 ? 0 : offset, 0}, [self slidingSizeForOffset:offset forOrientation:orientation] };
    }
    else {
        return (CGRect) { {0, self.resizesCenterView_ && offset < 0 ? 0 : offset}, [self slidingSizeForOffset:offset forOrientation:orientation] };
    }
}

- (CGSize)slidingSizeForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
    if (!self.resizesCenterView_) return self.referenceBounds_.size;
    
    offset = [self limitOffset:offset forOrientation:orientation];
    if (orientation == GLVIEW_ORIENTATION_HORIZONTAL) {
        return (CGSize) { self.centerViewBounds_.size.width - ABS(offset), self.centerViewBounds_.size.height };
    }
    else {
        return (CGSize) { self.centerViewBounds_.size.width, self.centerViewBounds_.size.height - ABS(offset) };
    }
}

-(void)setSlidingFrameForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
    [self setSlidingFrameForOffset:offset limit:YES panning:NO forOrientation:orientation];
}

-(void)panToSlidingFrameForOffset:(CGFloat)offset forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
...
-(void)setSlidingFrameForOffset:(CGFloat)offset limit:(BOOL)limit panning:(BOOL)panning forOrientation:(__enum_GLVIEW_ORIENTATION)orientation {
    ...
    self.slidingControllerView_.frame = [self slidingRectForOffset:_offset forOrientation:orientation];
...
- (void)hideAppropriateSideViews {
    self.leftViewController_.view.hidden = CGRectGetMinX(self.slidingControllerView_.frame) <= 0;
    self.rightViewController_.view.hidden = CGRectGetMaxX(self.slidingControllerView_.frame) >= self.referenceBounds_.size.width;
    self.topViewController_.view.hidden = CGRectGetMinY(self.slidingControllerView_.frame) <= 0;
    self.bottomViewController_.view.hidden = CGRectGetMaxY(self.slidingControllerView_.frame) >= self.referenceBounds_.size.height;
}

#pragma mark - ledges

- (void)setSize:(CGFloat)size forSide:(__enum_GLVIEW_SIDE)side completion:(void(^)(BOOL finished))completion {
    ...
    switch (side) {
        case GLVIEWSIDE_LEFT: {
            minLedge = MIN(self.referenceBounds_.size.width, ledge);
            offsetter = ^CGFloat(CGFloat l) { return  self.referenceBounds_.size.width - l; };
            break;
        }
            
        case GLVIEWSIDE_RIGHT: {
            minLedge = MIN(self.referenceBounds_.size.width, ledge);
            offsetter = ^CGFloat(CGFloat l) { return l - self.referenceBounds_.size.width; };
            break;
        }
            
        case GLVIEWSIDE_TOP: {
            minLedge = MIN(self.referenceBounds_.size.width, ledge);
            offsetter = ^CGFloat(CGFloat l) { return  self.referenceBounds_.size.height - l; };
            break;
        }
            
        case GLVIEWSIDE_BOTTOM: {
            minLedge = MIN(self.referenceBounds_.size.width, ledge);
            offsetter = ^CGFloat(CGFloat l) { return l - self.referenceBounds_.size.height; };
            break;
        }
    ...
    if (m_viewFirstAppeared_ && II_FLOAT_EQUAL(self.slidingControllerView.frame.origin.x, offsetter(_ledge[side]))) {
...
- (CGFloat)sizeForSide:(__enum_GLVIEW_SIDE)side {
...
- (CGFloat)sizeAsLedge:(CGFloat)size forSide:(__enum_GLVIEW_SIDE)side {
...
- (CGFloat)ledgeAsSize:(CGFloat)ledge forSide:(__enum_GLVIEW_SIDE)side {
    return [self ledgeAsSize:ledge mode:_sizeMode forSide:side];
}

- (CGFloat)ledgeAsSize:(CGFloat)ledge mode:(__enum_GLVIEW_SIZE_MODE)mode forSide:(__enum_GLVIEW_SIDE)side {
...
- (void)loadView
{
    ...
    m_viewFirstAppeared_ = NO;
    _viewAppeared = 0;
    self.view = II_AUTORELEASE([[GLViewDeckView alloc] init]);
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (!m_viewFirstAppeared_) {
        m_viewFirstAppeared_ = YES;
...
- (void)setLedgeValue:(CGFloat)ledge forSide:(__enum_GLVIEW_SIDE)side {
    if (_maxLedge > 0)
...
- (CGFloat)ledgeOffsetForSide:(__enum_GLVIEW_SIDE)viewDeckSide {
    switch (viewDeckSide) {
        case IIViewDeckLeftSide:
...
- (void)doForControllers:(void(^)(UIViewController* controller, __enum_GLVIEW_SIDE side))action {
    if (!action) return;
...
- (UIViewController*)controllerForSide:(__enum_GLVIEW_SIDE)viewDeckSide {
    return viewDeckSide == IIViewDeckNoSide ? nil : _controllers[viewDeckSide];
}

- (__enum_GLVIEW_SIDE)oppositeOfSide:(__enum_GLVIEW_SIDE)viewDeckSide {
    switch (viewDeckSide) {
        case IIViewDeckLeftSide:
...
- (void)notifyAppearanceForSide:(__enum_GLVIEW_SIDE)viewDeckSide animated:(BOOL)animated from:(int)from to:(int)to {
...
-(void)setCenterhiddenInteractivity:(__enum_GLVIEW_CENTER_VIEWCONTROLLER_HIDDEN_INTERACTIVITY)centerhiddenInteractivity {//IIViewDeckCenterHiddenInteractivity
...
- (BOOL)isSideClosed:(__enum_GLVIEW_SIDE)viewDeckSide {
...
- (BOOL)isSideOpen:(__enum_GLVIEW_SIDE)viewDeckSide {
    if (![self controllerForSide:viewDeckSide])
        return NO;
...
- (BOOL)isSideTransitioning:(__enum_GLVIEW_SIDE)viewDeckSide {
    return ![self isSideClosed:viewDeckSide] && ![self isSideOpen:viewDeckSide];
}

- (BOOL)openSideView:(__enum_GLVIEW_SIDE)side animated:(BOOL)animated completion:(GLViewDeckControllerBlock)completed {
    return [self openSideView:side animated:animated duration:DEFAULT_DURATION completion:completed];
}

- (BOOL)openSideView:(__enum_GLVIEW_SIDE)side animated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
...
- (BOOL)openSideView:(__enum_GLVIEW_SIDE)side bounceOffset:(CGFloat)bounceOffset targetOffset:(CGFloat)targetOffset bounced:(GLDeckViewControllerBaounceBlock)bounced completion:(GLDeckViewControllerBlock)completed {
    BOOL animated = YES;
...
- (BOOL)closeSideView:(__enum_GLVIEW_SIDE)side animated:(BOOL)animated completion:(GLDeckViewControllerBlock)completed {
    return [self closeSideView:side animated:animated duration:DEFAULT_DURATION completion:completed];
}

- (BOOL)closeSideView:(__enum_GLVIEW_SIDE)side animated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
    if ([self isSideClosed:side]) {
        if (completed) completed(self, YES);
        return YES;
    }
...
- (BOOL)closeSideView:(__enum_GLVIEW_SIDE)side bounceOffset:(CGFloat)bounceOffset bounced:(GLDeckViewControllerBaounceBlock)bounced completion:(GLDeckViewControllerBlock)completed {
    if ([self isSideClosed:side]) {
        if (completed) completed(self, YES);
        return YES;
    }
...
- (BOOL)closeLeftViewAnimated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
...
- (BOOL)closeRightViewAnimated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
...
- (BOOL)closeRightViewBouncing:(GLDeckViewControllerBaounceBlock)bounced completion:(IIViewDeckControllerBlock)completed {
...
- (BOOL)closeTopViewAnimated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
...
- (BOOL)closeBottomViewAnimated:(BOOL)animated duration:(NSTimeInterval)duration completion:(GLDeckViewControllerBlock)completed {
...
- (BOOL)closeBottomViewBouncing:(GLDeckViewControllerBaounceBlock)bounced completion:(IIViewDeckControllerBlock)completed {
...
- (BOOL)previewBounceView:(__enum_GLVIEW_SIDE)viewDeckSide {
...
- (void)setPanningView:(UIView *)panningView {
    if (_panningView != panningView) {
        ...
        if (m_viewFirstAppeared_ && _panningMode == IIViewDeckPanningViewPanning)
            [self addPanners];
    }
}
